...
export const PRODUCT_FIXTURES: Product[] = [
  ...
  },
  {
    ...
    variants: [
      { id: 'p3-v1', sku: 'TEE-003-83', attributes: { packSize: 100 }, price: 12.99, stock: 200 },
    ],
    rating: 4.6,
    reviewCount: 34,
    isFeatured: false,
  ...
  },
  {
    ...
    variants: [
      { id: 'p5-v1', sku: 'TWL-005', attributes: { colourway: 'White' }, price: 18.99, stock: 55 },
    ],
    rating: 4.7,
    reviewCount: 21,
    isFeatured: false,
  ...
  },
  {
    ...
    variants: [
      ...
      },
      {
        id: 'p6-v2',
        sku: 'BAG-006-GRN',
        attributes: { colourway: 'Forest Green' },
        price: 189.99,
        stock: 6,
      },
    ],
    ...
    variants: [
      {
        id: 'p8-v1',
        sku: 'APP-008-S-WHT',
        attributes: { size: 'S', colourway: 'White' },
        price: 59.99,
        stock: 20,
      },
      {
        id: 'p8-v2',
        sku: 'APP-008-M-WHT',
        attributes: { size: 'M', colourway: 'White' },
        price: 59.99,
        stock: 28,
      },
      {
        id: 'p8-v3',
        sku: 'APP-008-M-NVY',
        attributes: { size: 'M', colourway: 'Navy' },
        price: 59.99,
        stock: 22,
      },
    ],
