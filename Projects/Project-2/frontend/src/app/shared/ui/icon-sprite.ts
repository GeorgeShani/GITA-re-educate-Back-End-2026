...
@Component({
  ...
  template: `
    <svg xmlns="http://www.w3.org/2000/svg">
      ...
      <symbol id="email" viewBox="0 0 19.5 15.5">
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M18 4.15137L10.166 9.37402C9.91409 9.54197 9.58591 9.54197 9.33398 9.37402L1.5 4.15137V12.75C1.5 13.4404 2.05964 14 2.75 14H16.75C17.4404 14 18 13.4404 18 12.75V4.15137ZM1.5542 2.38477L9.75 7.84863L17.9458 2.38477C17.7896 1.87259 17.3133 1.5 16.75 1.5H2.75C2.18671 1.5 1.71044 1.87259 1.5542 2.38477ZM19.5 2.73732C19.4931 1.22437 18.2646 0 16.75 0H2.75C1.23544 0 0.00684496 1.22438 2.85022e-05 2.73735M19.5 2.75936V12.75C19.5 14.2688 18.2688 15.5 16.75 15.5H2.75C1.23122 15.5 0 14.2688 0 12.75V2.75934M19.5 2.75V2.75936Z"
          fill="currentColor"
        />
      </symbol>
    </svg>
