  ...
  describe('GET /subscriptions/plans', () => {
    it('is public and lists the three plans with the brief’s numbers', async () => {
      ...
      expect(response.body).toEqual([
        { plan: 'free', maxEmployees: 0, maxSeats: 1, filesPerPeriod: 10, seatPriceCents: 0, basePriceCents: 0, overagePerFileCents: null, rateLimitPerMinute: 30, maxQualityRules: 3, maxVersionsPerDataset: 5 },
        { plan: 'basic', maxEmployees: 10, maxSeats: 11, filesPerPeriod: 100, seatPriceCents: 500, basePriceCents: 0, overagePerFileCents: null, rateLimitPerMinute: 120, maxQualityRules: 25, maxVersionsPerDataset: 50 },
        { plan: 'premium', maxEmployees: null, maxSeats: null, filesPerPeriod: 1000, seatPriceCents: 0, basePriceCents: 30_000, overagePerFileCents: 50, rateLimitPerMinute: 600, maxQualityRules: null, maxVersionsPerDataset: null },
      ]);
    });
  });
